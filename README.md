...
- 🌱 I’m currently learning ***```Advanced CSS & Sass in Udemy```*** and started doing **Tests** using the **```TDD Methodology```**.
...
- ✍🏽 Authoring ***articles*** on [**```LinkedIn```**](https://www.linkedin.com/in/chen-abudi/) to share my insights and experiences about topics in software development.
