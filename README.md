...
<h2 align="center">🔓 Opened to Full-Stack/FE/Software Developer Positions Offers‼️</h2>
...
- 🌱 I'm currently learning **``` Advanced Backend (e.g. Java, and Web Scraping)```**, **``` Math, Data Structures, and Algorithm ```**. 
