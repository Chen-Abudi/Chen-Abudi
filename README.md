...
- 🔭 I'm currently working on: [**AlohaGracefulCode 🌺**](https://github.com/Chen-Abudi/AlohaGracefulCode), and on **Spring MVC Validation project**.
...
- 🌱 I'm currently learning ***``` Spring MVC with Thymeleaf ```***.
